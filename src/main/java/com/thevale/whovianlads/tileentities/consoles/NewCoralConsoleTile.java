...
public class NewCoralConsoleTile extends ConsoleTile {
    ...
    public NewCoralConsoleTile() {
        this(ValeTiles.console_newcoral.get());
    }

    public NewCoralConsoleTile(TileEntityType<?> type) {
        super(type);
