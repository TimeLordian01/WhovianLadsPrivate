package com.thevale.whovianlads.client.guis.monitors;
...
public class CoralMonitorScreen extends BaseMonitorScreen {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation("whovianlads", "textures/gui/monitors/coralconsole.png");
