...
public class BlueDoctorExterior extends ExteriorModel {
	...
	public BlueDoctorExterior() {
		...
		shell.setTextureOffset(0, 0).addBox(-12.0F, -1.0F, -12.0F, 24.0F, 2.0F, 24.0F, 0.0F, false);
		shell.setTextureOffset(0, 50).addBox(-9.0F, -43.0F, -11.0F, 18.0F, 4.0F, 22.0F, 0.0F, false);
		shell.setTextureOffset(138, 88).addBox(-9.0F, -42.5F, -11.5F, 18.0F, 3.0F, 1.0F, 0.0F, false);
		shell.setTextureOffset(136, 135).addBox(-9.0F, -42.5F, 10.5F, 18.0F, 3.0F, 1.0F, 0.0F, false);
		shell.setTextureOffset(58, 50).addBox(-11.0F, -43.0F, -9.0F, 22.0F, 4.0F, 18.0F, 0.0F, false);
		shell.setTextureOffset(0, 130).addBox(-10.25F, -39.0F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);
		shell.setTextureOffset(69, 26).addBox(-9.0F, -44.5F, -9.0F, 18.0F, 2.0F, 18.0F, 0.01F, false);
		shell.setTextureOffset(72, 0).addBox(-8.5F, -45.5F, -8.5F, 17.0F, 2.0F, 17.0F, 0.01F, false);
		shell.setTextureOffset(0, 0).addBox(-1.5F, -49.0F, -1.5F, 3.0F, 3.0F, 3.0F, 0.0F, false);
		shell.setTextureOffset(0, 6).addBox(-1.0F, -46.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.01F, false);
		shell.setTextureOffset(8, 2).addBox(-1.0F, -49.5F, -2.0F, 2.0F, 1.0F, 4.0F, 0.01F, false);
		shell.setTextureOffset(0, 12).addBox(-1.5F, -49.5F, -1.5F, 3.0F, 1.0F, 3.0F, 0.02F, false);
		shell.setTextureOffset(0, 26).addBox(-11.5F, -2.0F, -11.5F, 23.0F, 1.0F, 23.0F, 0.0F, false);
		shell.setTextureOffset(120, 146).addBox(-11.0F, -44.0F, -11.0F, 2.0F, 42.0F, 2.0F, 0.0F, false);
		shell.setTextureOffset(100, 72).addBox(-10.0F, -38.0F, -9.0F, 1.0F, 36.0F, 18.0F, 0.0F, false);
		shell.setTextureOffset(0, 76).addBox(9.0F, -38.0F, -9.0F, 1.0F, 36.0F, 18.0F, 0.0F, false);
		shell.setTextureOffset(112, 146).addBox(9.0F, -44.0F, -11.0F, 2.0F, 42.0F, 2.0F, 0.0F, false);
		shell.setTextureOffset(96, 145).addBox(9.0F, -44.0F, 9.0F, 2.0F, 42.0F, 2.0F, 0.0F, false);
		shell.setTextureOffset(104, 145).addBox(-11.0F, -44.0F, 9.0F, 2.0F, 42.0F, 2.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(0.0F, 0.0F, -1.0F);
		shell.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, -1.5708F, 0.0F);
		cube_r1.setTextureOffset(62, 72).addBox(10.0F, -38.0F, -9.0F, 1.0F, 36.0F, 18.0F, 0.0F, false);
		cube_r1.setTextureOffset(116, 127).addBox(-9.75F, -39.5F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);
		cube_r1.setTextureOffset(96, 126).addBox(-9.25F, -39.0F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(0.0F, -49.7F, 0.0F);
		shell.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, -1.5708F, 0.0F);
		cube_r2.setTextureOffset(0, 16).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, 0.01F, false);

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(0.0F, -49.0F, 0.0F);
		shell.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, -1.5708F, 0.0F);
		cube_r3.setTextureOffset(0, 6).addBox(-1.0F, -0.5F, -2.0F, 2.0F, 1.0F, 4.0F, 0.01F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-0.5F, -45.5F, 0.5F);
		shell.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, -1.5708F, 0.0F);
		cube_r4.setTextureOffset(12, 12).addBox(-2.0F, -0.5F, -2.0F, 3.0F, 1.0F, 3.0F, 0.02F, false);

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(0.0F, -45.5F, 0.0F);
		shell.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, -1.5708F, 0.0F);
		cube_r5.setTextureOffset(8, 7).addBox(-1.0F, -0.5F, -2.0F, 2.0F, 1.0F, 4.0F, 0.01F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(11.7606F, -42.426F, 0.0F);
		shell.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, -1.5708F, 0.48F);
		cube_r6.setTextureOffset(72, 19).addBox(-9.0F, -0.158F, 0.9397F, 18.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(-10.8736F, -42.8877F, 0.0F);
		shell.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 1.5708F, -0.48F);
		cube_r7.setTextureOffset(92, 46).addBox(-9.0F, -0.158F, -0.0603F, 18.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(0.0F, -42.8877F, 10.8736F);
		shell.addChild(cube_r8);
		setRotationAngle(cube_r8, -2.6616F, 0.0F, -3.1416F);
		cube_r8.setTextureOffset(120, 84).addBox(-9.0F, -0.158F, -0.0603F, 18.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.0F, -42.8722F, -10.8893F);
		shell.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.48F, 0.0F, 0.0F);
		cube_r9.setTextureOffset(123, 39).addBox(-9.0F, -0.158F, -0.0603F, 18.0F, 1.0F, 3.0F, 0.0F, false);

		cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(-1.0F, 0.0F, 0.0F);
		shell.addChild(cube_r10);
		setRotationAngle(cube_r10, 0.0F, 0.0F, 0.0F);
		cube_r10.setTextureOffset(120, 46).addBox(-9.75F, -39.5F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(0.0F, 0.0F, 1.0F);
		shell.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, 1.5708F, 0.0F);
		cube_r11.setTextureOffset(120, 108).addBox(-9.75F, -39.5F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);
		cube_r11.setTextureOffset(120, 65).addBox(-9.25F, -39.0F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);

		cube_r12 = new ModelRenderer(this);
		cube_r12.setRotationPoint(1.0F, 0.0F, 0.0F);
		shell.addChild(cube_r12);
		setRotationAngle(cube_r12, -3.1416F, 0.0F, 3.1416F);
		cube_r12.setTextureOffset(123, 20).addBox(-9.75F, -39.5F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);
		cube_r12.setTextureOffset(122, 1).addBox(-9.25F, -39.0F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);

		cube_r13 = new ModelRenderer(this);
		cube_r13.setRotationPoint(11.0F, -41.0F, 0.0F);
		shell.addChild(cube_r13);
		setRotationAngle(cube_r13, 0.0F, -1.5708F, 0.0F);
		cube_r13.setTextureOffset(136, 127).addBox(-9.0F, -1.5F, -0.5F, 18.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r14 = new ModelRenderer(this);
		cube_r14.setRotationPoint(-11.0F, -41.0F, 0.0F);
		shell.addChild(cube_r14);
		setRotationAngle(cube_r14, 0.0F, -1.5708F, 0.0F);
		cube_r14.setTextureOffset(136, 131).addBox(-9.0F, -1.5F, -0.5F, 18.0F, 3.0F, 1.0F, 0.0F, false);
		...
		cube_r15.setRotationPoint(-10.0F, 19.0F, -11.0F);
		rightdoor.addChild(cube_r15);
		setRotationAngle(cube_r15, 0.0F, -1.5708F, 0.0F);
		cube_r15.setTextureOffset(76, 126).addBox(10.0F, -38.0F, -10.0F, 1.0F, 36.0F, 9.0F, 0.0F, false);
		...
		cube_r16.setRotationPoint(0.0F, 19.0F, -11.0F);
		leftdoor.addChild(cube_r16);
		setRotationAngle(cube_r16, 0.0F, -1.5708F, 0.0F);
		cube_r16.setTextureOffset(38, 76).addBox(10.0F, -38.0F, -9.0F, 1.0F, 36.0F, 9.0F, 0.0F, false);
	...
	public void renderBoti(ExteriorTile exterior, float scale, MatrixStack matrixStack, IVertexBuilder buffer,
		...
		if(exterior.getBotiWorld() != null && exterior.getOpen() != EnumDoorState.CLOSED) {
			...
			info.setRenderDoor((matrix, buf) -> {
				...
				matrix.translate(0,-0.1,0);
				this.doors.render(matrix, buf.getBuffer(RenderType.getEntityCutout(BlueDoctorRender.TEXTURE)), packedLight, packedOverlay);
				matrix.pop();
			});
