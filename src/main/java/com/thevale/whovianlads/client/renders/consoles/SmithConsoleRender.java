...
import com.thevale.whovianlads.client.models.consoles.SmithConsole;
...
public class SmithConsoleRender extends TileEntityRenderer<SmithConsoleTile> {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(whovianlads.MODID, "textures/consoles/smithconsole.png");
