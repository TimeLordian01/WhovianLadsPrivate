...
import com.thevale.whovianlads.client.models.consoles.CoralConsole;
...
public class CoralConsoleRender extends TileEntityRenderer<CoralConsoleTile> {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(whovianlads.MODID, "textures/consoles/coralconsole.png");
