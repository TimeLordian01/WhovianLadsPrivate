...
public class ValeExteriorRegistry {
    ...
    public static final RegistryObject<AbstractExterior> CLASSIC_HARTNELL = EXTERIORS.register("classic_hartnell",
            () -> new TwoBlockBasicExterior(() -> ValeBlocks.exterior_classic_hartnell.get().getDefaultState(),
                    true, EnumDoorTypes.HARTNELL, DoorSounds.WOOD,
                    new ResourceLocation(whovianlads.MODID, "textures/gui/exteriors/hartnell.png")));
}
